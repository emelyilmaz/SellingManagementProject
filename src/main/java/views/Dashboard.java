...
public class Dashboard extends Base {
    ...
    SalesImpl getSalesImpl = new SalesImpl(date1, date2);
    ...
    private void btnCompleteSaleClick(ActionEvent e) {
        ...
        if (total == 0) {
            ...
            if (status > 0) {
                ...
                String totalProfit=String.valueOf(salesImpl.CalculateTotalProfit(salesImpl.baketReportList(date1,date2)));
                lblRepotsProfit.setText(totalProfit);
                getSalesImpl.setLstReport(getSalesImpl.baketReportList(date1,date2));
    ...
    private void txtReportSearchKeyReleased(KeyEvent e) {
        ...
        if (customer) {
            tblReport.setModel(getSalesImpl.bakettableModel_Report(data, "customer"));
            lblReportError.setText("");

        } else if (category) {
            tblReport.setModel(getSalesImpl.bakettableModel_Report(data, "category"));
            lblReportError.setText("");
        } else if (product) {
            tblReport.setModel(getSalesImpl.bakettableModel_Report(data, "product"));
            lblReportError.setText("");
        } else {
            ...
            //======== panel5 ========
            {
                ...
                //======== panel7 ========
                {
                    ...
                    //======== scrollPane1 ========
                    {
                        ...
                        tblCategory.setSelectionBackground(new Color(255, 154, 47));
            ...
            //======== panel4 ========
            {
                ...
                //======== panel14 ========
                {
                    ...
                    //======== scrollPane7 ========
                    {
                        ...
                        tblProduct.setSelectionBackground(new Color(255, 154, 47));
                ...
                //======== panel16 ========
                {
                    ...
                    lbllAddError.setHorizontalAlignment(SwingConstants.CENTER);
                ...
                //======== panel17 ========
                {
                    ...
                    lblUpdateError.setHorizontalAlignment(SwingConstants.CENTER);
                                    ...
                                    .addGroup(panel17Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addGroup(GroupLayout.Alignment.LEADING, panel17Layout.createSequentialGroup()
                                            ...
                                            .addGroup(panel17Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                                .addComponent(txtProductUpdateStockQua, GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
                                                .addComponent(txtProductUpdateSalePrice, GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE))))
                                        ...
                                        .addGroup(GroupLayout.Alignment.TRAILING, panel3Layout.createSequentialGroup()
                                            .addGroup(panel3Layout.createParallelGroup()
                                                ...
                                                .addGroup(panel3Layout.createSequentialGroup()
                                                    ...
                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                    .addComponent(btnCancelSale, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE)))
                                            .addGap(10, 10, 10)))
                                    .addGap(12, 12, 12))
                                .addGroup(panel3Layout.createSequentialGroup()
