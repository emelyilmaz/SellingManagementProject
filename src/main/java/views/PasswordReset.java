...
public class PasswordReset extends  Base{
    ...
    private void btnSaveClick(ActionEvent e) {
      ...
      String validateCode=  txtValidate.getText().trim();

            if(password.equals("")){
                lblError2.setText("Password can not be empty !!!!!");

            }else if(!validateCode.equals(us.userGetVerification(us.emailaddress))){
                lblError2.setText("Please enter the verification code  sent to your e-mail correctly");
            }
            else{
    ...
    private void initComponents() {
        ...
        contentPaneLayout.setHorizontalGroup(
            contentPaneLayout.createParallelGroup()
                ...
                .addGroup(contentPaneLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(lblError2, GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addContainerGap())
        );
